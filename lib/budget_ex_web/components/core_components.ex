defmodule BudgetExWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BudgetExWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BudgetExWeb.Gettext, "errors", msg, opts)
    end
  end
